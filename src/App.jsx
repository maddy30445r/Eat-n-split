...
import myimng from './assets/4452317.jpg';
...
function Logo() {
  return (
    <div className=" mix-blend-hard-light bg-[#f9b98b]  font-playright text-3xl text-[#190B02] underline sm:text-5xl text-center py-4">
      🍕 Eat - n -split 🍔
    </div>
  );
}
